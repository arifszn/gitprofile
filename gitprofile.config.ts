...
const CONFIG = {
    ...
    github: {
      ...
      automatic: {
        ...
        exclude: {
          ...
          projects: [
            'mehtadome/Firewire',
            'mehtadome/old-mehtadome.github.io',
            'mehtadome/Notes',
            'mehtadome/mehtadome',
            'mehtadome/SCU',
    ...
    external: {
      ...
      projects: [
        ...
        },
        {
          ...
          imageUrl: '/img/fusionad-logo.png',
  ...
  seo: {
    title: 'Portfolio of Ruchir Mehta',
    description: 'Senior Solutions Architect @ Accenture',
    imageURL: '',
  },
  social: {
  ...
  experiences: [
    {
      ...
      to: 'Present',
      companyLink:
        'https://newsroom.accenture.com/news/2019/accenture-launches-synops-a-human-machine-operating-engine-designed-to-help-enterprises-achieve-sustainable-competitive-advantage',
    },
    {
      ...
      to: 'Present',
      companyLink:
        'https://www.scu.edu/engineering/undergraduate/student-support/mentor-collective/',
    },
    {
