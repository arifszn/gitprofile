...
const CONFIG = {
  github: {
    username: 'titoo-dev', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  experiences: [
    {
      ...
      from: 'July 2022',
      to: 'Present',
      companyLink: 'https://www.bocasay.com',
    },
    {
      company: 'Flit Soft',
      position: 'Javascript & Flutter Developer',
      from: 'March 2022',
      to: 'July 2022',
      companyLink: 'https://www.flitsoft.com/',
    },
  ],
  certifications: [
    // {
  ...
  educations: [
    {
      institution: 'INSTITUT SUPERIEUR POLYTECHNIQUE DE MADAGASCAR',
