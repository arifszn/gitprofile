...
const config = {
  github: {
    ...
    exclude: {
      ...
      projects: ['Financial_portfolio_case','Infrastructure_analysis', 'Social_analytics', 'Energy_sector_analysis','-Hello_World-','MyFirstRepo','somer-sinnard.github.io_temp','HW12','somer-sinnard','somer-sinnard.github.io_temp_1','somer-sinnard.github.io_temp'], // These projects will not be displayed. example: ['my-project1', 'my-project2']
    },
  },
  social: {
