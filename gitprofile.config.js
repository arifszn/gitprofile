...
const config = {
  github: {
    ...
    exclude: {
      ...
      projects: ['Bio','-Hello_World-','MyFirstRepo','somer-sinnard.github.io_temp','HW12','Somer-Sinnard'], // These projects will not be displayed. example: ['my-project1', 'my-project2']
    },
  },
  social: {
