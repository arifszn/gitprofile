...
It will show as Default if you set `defaultTheme` to `procyon`.
...
const CONFIG = {
  ...
  resume: {
    fileUrl: 'blob:https://github.com/879ebb7f-94b1-41ff-93bf-466e025d911e', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'PHP',
    'Laravel',
